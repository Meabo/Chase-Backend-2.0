...
exports.distanceByLoc = distanceByLoc;
function robustPointInPolygon(vs, point) {
    ...
    for (let i = 0, j = n - 1; i < lim; j = i++) {
        ...
        if (yj < yi) {
            if (yj < y && y < yi) {
                const s = orientation_1.default.orientation3(a, b, point);
                if (s === 0) {
                    return 0;
                }
                else {
...
exports.robustPointInPolygon = robustPointInPolygon;
function getRandomLocationInsidePolygon(polygon) {
    const r = Math.random();
    const t = Math.random();
...
exports.getRandomLocationInsidePolygon = getRandomLocationInsidePolygon;
